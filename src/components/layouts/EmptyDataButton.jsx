export default function EmptyDataButton({ onClick, children }) {
  return (
    ...
    >
      ...
      <span class="relative w-full text-left transition-colors duration-200 ease-in-out group-hover:text-white dark:group-hover:text-gray-200 text-xs md:text-base">
        {children}
      </span>
    </button>
  );
